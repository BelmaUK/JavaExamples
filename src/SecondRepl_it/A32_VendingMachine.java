...
public class A32_VendingMachine {
...
Do not display anything else.
    ...
    Scanner scan = new Scanner(System.in);{
        ...
        else
        {
            ...
            int RemainingitemPrice = 100-itemPrice;

            int quarters= (RemainingitemPrice-RemainingitemPrice%25)/25;
            RemainingitemPrice =RemainingitemPrice- (25*quarters);
            int dimes=(RemainingitemPrice-RemainingitemPrice%10)/10;
            RemainingitemPrice =RemainingitemPrice- (10*dimes);
            int nickels=RemainingitemPrice/5;
