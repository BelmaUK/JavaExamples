...
public class A24_SchoolGrades {
   /*

Write the program that will calculate average grade.
Declare 5 String variables: subject1,  subject2, subject3,  subject4, summary;
Declare 5 float variables: grade1,  grade2, grade3,  grade4, average;
...
-Display prompt: "Goodbye!"
   ...
   public static void main(String[] args) {
       ...
       average= (grade1 + grade2 + grade3 + grade4) / 4f;
